...
?>  
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      ...
      <input type="name" name="projectname" class="form-control" id="name" placeholder="Web Development, Mobile App, Ui/Ux Design">
    </div>
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" name="projectlink" class="form-control" id="email" placeholder="web, ux, app">
    </div>
