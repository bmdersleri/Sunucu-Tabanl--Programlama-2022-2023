<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("delete from hizmetler");
        $sorgu = $baglan->query("insert into hizmetler (aciklama) values ('$aciklama')");
        echo "<script> window.location.href='hizmetler.php'; </script>";
    }

    $sorgu = $baglan->query("select * from hizmetler");
...
<head>
    <meta charset="utf-8">
    <title>Yönetim Paneli Hizmetler</title>
</head>
