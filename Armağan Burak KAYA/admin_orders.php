...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> kullanıcı adı : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         <p> isim : <span><?php echo $fetch_orders['name']; ?></span> </p>
         <p> tel no : <span><?php echo $fetch_orders['number']; ?></span> </p>
         <p> email : <span><?php echo $fetch_orders['email']; ?></span> </p>
         <p> adres : <span><?php echo $fetch_orders['address']; ?></span> </p>
         <p> toplam ürünler : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> toplam fiyat : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         <p> ödeme metodu : <span><?php echo $fetch_orders['method']; ?></span> </p>
      ...
      <?php
         ...
         echo '<p class="empty">henüz sipariş verilmemiş</p>';
      }
      ?>
   </div>
