...
// Blogların Kategorisini alma
$stmt = $conn->prepare("SELECT * FROM `category` WHERE `category_id` = ?");
$stmt->execute([$article["id_categorie"]]);
$category = $stmt->fetch();

//Yazarın Bloglarını Alma
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="aside col-3">
                    ...
                    <div class="card bg-light my-3">
                        <div class="card-header"><strong> <?= $article['author_fullname'] ?> 'dan Daha Fazla </strong></div>
            ...
            <div id="comment" class="row">
                <div class="col-lg-9 border p-4 mt-3 bg-white">
                    ...
                    <div class="comments">
                        <h2 class="text-center text-muted py-3">Yorumlar</h2>
                    ...
                    <div class="post-comments">
                        ...
                        <form action="assest/insert.php?type=comment&id=<?= $article_id ?>#comment" method="POST">
                            <div class="form-group mt-3">
                                ...
                                <button name="submit" type="submit" class="btn btn-success float-right mt-1">Yorum Ekle</button>
                            </div>
                            <div class="clearfix"></div>
                        </form>
