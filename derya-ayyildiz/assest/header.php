        ...
        <div class="d-flex flex-column flex-md-row align-items-center py-2">
            ...
            <?php if ($loggedin) : ?>
                ...
                <nav class="my-2 my-md-0 mr-md-3">
                    <a class="p-2 px-5 text-muted" href="index.php">Anasayfa</a>
                    <a class="p-2 px-5 text-muted" href="categories.php">Kategori</a>
                    <a class="p-2 px-5 text-muted" href="article.php">Blog</a>
                    <a class="p-2 px-5 text-muted" href="author.php">Yazar</a>
                </nav>

            <?php else : ?>
                <nav class="my-2 my-md-0 mr-md-3">
                    <a class="p-2 px-5 text-muted" href="articleOfCategory.php">Bloglar</a>
                </nav>
