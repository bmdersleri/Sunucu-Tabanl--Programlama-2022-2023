...
$categoriesAsk = $conn->prepare("SELECT * FROM category");
$categoriesAsk->execute();
$categories = $categoriesAsk->fetchAll();
...
<body>
    ...
    <main role="main" class="main">
        ...
        <div class="jumbotron text-center mb-0">
            <h1 class="display-3 font-weight-normal text-muted">Kategorileri Listele</h1>
        </div>
