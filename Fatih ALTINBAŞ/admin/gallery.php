                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="image_name">Resim Adi</label>
                                ...
                                <div class="form-group">
                                    <label for="gallery_image">Resim</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-info" id="add_image_bttn">Ekle</button>
                            </div>
                        </div>
                    </div>
                </div>
