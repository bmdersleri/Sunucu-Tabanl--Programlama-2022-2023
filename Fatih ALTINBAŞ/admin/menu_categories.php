            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Yeni Katagori</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="category_name">Katagori ismi</label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-info" id="add_category_bttn">Ekle</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered categories-table">
                        <thead>
                            <tr>
                                <th scope="col">Katagori ID</th>
                                <th scope="col">Katagori Adi</th>
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip" title="Delete">
		                                                    ...
		                                                    <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
		                                                        <div class="modal-dialog" role="document">
		                                                            <div class="modal-content">
		                                                                <div class="modal-header">
		                                                                    <h5 class="modal-title">Katagoriyi sil</h5>
		                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		                                                                        <span aria-hidden="true">&times;</span>
		                                                                    </button>
		                                                                </div>
		                                                                <div class="modal-body">
		                                                                    Secili Katagori Silinecek Eminmisiniz ? "<?php echo strtoupper($category['category_name']); ?>"?
		                                                                </div>
		                                                                <div class="modal-footer">
