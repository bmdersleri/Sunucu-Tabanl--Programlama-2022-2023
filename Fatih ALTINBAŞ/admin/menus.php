                        ...
                        <table class="table table-bordered menus-table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Menu Katagorisi</th>
                                    <th scope="col">Aciklama</th>
                                    <th scope="col">Fiyat</th>
                                    <th scope="col">Yonet</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                                ...
                                                /****/
                                                    ...
                                                    ?>
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Goruntule">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Duzenle">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Sil">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Menu'yu Sil</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                Secilen Menu Silinecek Onaylıyormusunuz ?  "<?php echo strtoupper($menu['menu_name']); ?>"?
                                                                            </div>
                                ...
                                <div class="panel-X">
                                    ...
                                    <div class="save-header-X">
                                        <div style="display:flex">
                                            ...
                                            <div class="title-container">Aciklama</div>
                                        </div>
                                        <div class="button-controls">
                                            <button type="submit" name="add_new_menu" class="btn btn-primary">Kaydet</button>
                                        </div>
                                    </div>
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            <label for="menu_name">Menu Adi Giriniz</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label for="menu_category">Menu Katagorsi Seciniz</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_description">Menu Aciklamasi Giriniz</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']))
                                                {
                                                    ...
                                                    elseif(strlen(test_input($_POST['menu_description'])) > 300)
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Aciklama 300 Karakterden Uzun Olamaz
                                                            </div>
                                                        <?php
                                        ...
                                        <div class="form-group">
                                            <label for="menu_price">Menu Fiyatini Giriniz(₺)</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_image">Menu Resimi</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST')
                                                {
                                                    ...
                                                    if(!empty($_FILES['menu_image']['name']) && !in_array($image_extension,$image_allowed_extension))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Desteklenmyen uzan JPEG, JPG veya PNG Görüntü Dosyası Seciniz
                                                            </div>
                                                        <?php
