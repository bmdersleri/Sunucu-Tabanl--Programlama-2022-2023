...
<body>
	...
	<div class="container">
<h2> E-Öğrencilerin Kayıt listesi </h2>
<h2>  </h2>
...
?>
	...
	<a href="logout.php" class="btn btn-success"><i class="fa fa-lock"></i> Çıkış Yap</a>
	<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">
  <i class="fa fa-plus"></i> Yeni Öğrenci Ekle
  </button>
  <a href="export.php" class="btn btn-success pull-right"><i class="fa fa-download"></i> Verileri dışa aktar</a>
  <hr>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">No:</th>
				...
				<th class="text-center" scope="col">Öğrenci Id.</th>
				<th class="text-center" scope="col">Cep Telefon</th>
				<th class="text-center" scope="col">Personel Id</th>
				<th class="text-center" scope="col">Göster</th>
				<th class="text-center" scope="col">Düzenle</th>
				<th class="text-center" scope="col">Silme</th>
			</tr>
		</thead>
			<?php
     ...
     <input type="submit" name="export" class="btn btn-success" value="Verileri indir" />
    </form>
	</div>
...
<label for="inputEmail4">Öğrenci ID.</label>
...
<div class="form-group col-md-6">
<label for="inputPassword4">D.Tarih</label>
...
<label for="inputState">Mah</label>
<select name="state" class="form-control">
  <option selected>Choose...</option>
  <option value="Andhra Pradesh">asdfgh</option>
									<option value="Andaman and Nicobar Islands">absd</option>
									<option value="Arunachal Pradesh">rhuuuu</option>
									<option value="Assam">bbbbbnm</option>
...
<div id='$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
        <button type='button' class='close' data-dismiss='modal'>&times;</button>
        <h4 class='modal-title text-center'>Silmek istiyor musun??</h4>
      </div>
      <div class='modal-body'>
        <a href='delete.php?id=$id' class='btn btn-danger' style='margin-left:250px'>Evet</a>
      </div>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
             <button type='button' class='close' data-dismiss='modal'>&times;</button>
             <h4 class='modal-title text-center'>Verileri düzenle</h4> 
      </div>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Cep Telefon.</label>
		...
		<select name='state' class='form-control'>
		  ...
		  <option value='Andhra Pradesh'>Andhra Pradesh</option>
											<option value='Andaman and Nicobar Islands'>asdfgh</option>
											<option value='Arunachal Pradesh'>ppfoo</option>
											<option value='abcd'>ıooo</option>
		...
		<div class='form-group'>
        	...
        	<div class='form-group'>
			 ...
			 <div class='modal-footer'>
			 <input type='submit' name='submit' class='btn btn-info btn-large' value='Tamam'>
			 <button type='button' class='btn btn-secondary' data-dismiss='modal'>Kapat</button>
		 </div>
