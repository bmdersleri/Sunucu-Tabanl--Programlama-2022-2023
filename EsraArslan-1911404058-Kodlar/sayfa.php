...
$sorgu = $db->prepare("select * from sayfalar where sefurl=?"); $sorgu->execute(array($url)); if($sorgu->rowCount()=="0"){ header("Location:index.php"); }else{ $gelen = $sorgu->fetch(PDO::FETCH_ASSOC); ?>
<!DOCTYPE html>
<html lang="en"> 
<head>
    <meta charset="utf-8">
...
<body  >
    ...
    <div class="main-wrapper">
		    <div class="container">
			    <h2 class="title mb-3 " style="color:#FFFFFF; text-align:; font-style: italic;"><?php echo $gelen['baslik']; ?></h2>
                <br>
