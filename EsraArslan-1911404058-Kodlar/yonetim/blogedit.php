...
$kayit = $db->prepare("update blog set baslik=?,resim=?,icerik=?,sefurl=? where id=?"); 
$kayit->execute(array($_POST['baslik'], $_POST['resim'], $_POST['icerik'], $sef, $id));
...
<?php foreach($db->query("select * from blog where id='".$id."'") as $aaa){ ?>
		...
		<div class="control-group">											
			...
			<div class="controls">
			<input type="text" class="span6" name="resim" value="<?php echo $aaa['resim']; ?>">
