...
<link href="assets/dist/css/bootstrap.css" rel="stylesheet">
  ...
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="php/logout.php">Çıkış</a>
    </li>
  </ul>
</nav>
...
?> 
    ...
    <label for="ptitle">İsim</label>
    <input type="text" name="username" value="<?=$data['username']?>" class="form-control" id="ptitle" placeholder="Bera Yıldız">
  </div>
        <div class="form-group col-md-6">
    <label for="psubtitle">Şifre</label>
    ...
    <input type="text" name="userid" value="<?=$data['user_id']?>" class="form-control" id="psubtitle" placeholder="site@admin.com">
  </div>
         </div>
         <input type="submit" name="uprofile" class="btn btn-primary" value="Kaydet">
         </form>
    <?php }else{
